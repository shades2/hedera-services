...
public class StaticPrecompileSuite extends HapiApiSuite {
    private static final Logger log = LogManager.getLogger(StaticPrecompileSuite.class);
    ...
    public static void main(String... args) {
        new StaticPrecompileSuite().runSuiteSync();
    }
    ...
    private HapiApiSpec staticCallForTransfer() {
        ...
        return defaultHapiSpec("staticCallForTransfer")
                .given(
    ...
    private HapiApiSpec staticCallForBurn() {
        final AtomicReference<TokenID> vanillaTokenTokenID = new AtomicReference<>();
        final var supplyKey = "supplyKey";

        return defaultHapiSpec("staticCallForBurn")
                .given(
                        newKeyNamed(supplyKey),
                        fileCreate(INNER_CONTRACT).payingWith(GENESIS),
                        updateLargeFile(GENESIS, INNER_CONTRACT, extractByteCode(ContractResources.SERVICE_CONTRACT)),
    ...
    private HapiApiSpec staticCallForMint() {
        final AtomicReference<TokenID> vanillaTokenTokenID = new AtomicReference<>();
        final var supplyKey = "supplyKey";

        return defaultHapiSpec("staticCallForMint")
                .given(
                        newKeyNamed(supplyKey),
                        fileCreate(INNER_CONTRACT).payingWith(GENESIS),
                        updateLargeFile(GENESIS, INNER_CONTRACT, extractByteCode(ContractResources.SERVICE_CONTRACT)),
