...
dependencies {
    ...
    jmhImplementation("com.swirlds:swirlds-common:0.21.0-vm-alpha.5")
    jmhImplementation("com.swirlds:swirlds-merkle:0.21.0-vm-alpha.5")
    jmhImplementation("com.swirlds:swirlds-virtualmap:0.21.0-vm-alpha.5")
    jmhImplementation("com.swirlds:swirlds-jasperdb:0.21.0-vm-alpha.5")
    jmhImplementation("com.swirlds:swirlds-logging:0.21.0-vm-alpha.5")
