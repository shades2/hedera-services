...
//class ContractCreateAccessorTest {
...
//				.build();
//		givenTxn(createTxn);
//		accessor = new ContractCreateAccessor(topicCreateTxn, aliasManager);
//
...
//		assertEquals(payer, accessor.getPayer());ContractUpdateTransitionLogicTest.java
//	}
//
//	@Test
