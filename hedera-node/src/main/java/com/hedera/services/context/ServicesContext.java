	...
	private Function<HederaFunctionality, List<TransitionLogic>> transitions() {
		...
		Map<HederaFunctionality, List<TransitionLogic>> transitionsMap = Map.ofEntries(
				...
				entry(TokenFreezeAccount,
						List.of(new TokenFreezeTransitionLogic(typedTokenStore(), txnCtx()))),
				entry(TokenUnfreezeAccount,
						List.of(new TokenUnfreezeTransitionLogic(typedTokenStore(), txnCtx()))),
				entry(TokenGrantKycToAccount,
						List.of(new TokenGrantKycTransitionLogic(typedTokenStore(), txnCtx()))),
				entry(TokenRevokeKycFromAccount,
						List.of(new TokenRevokeKycTransitionLogic(typedTokenStore(), txnCtx()))),
				entry(TokenDelete,
				...
				entry(TokenDissociateFromAccount,
						List.of(new TokenDissociateTransitionLogic(accountStore(), typedTokenStore(), ledger(), txnCtx()))),
				/* Schedule */
