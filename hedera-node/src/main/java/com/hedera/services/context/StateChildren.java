...
public class StateChildren {
	...
	private MerkleMap<ChunkPath, KeyedChunk<ChunkPath>> storage;
	...
	public MerkleMap<ChunkPath, KeyedChunk<ChunkPath>> getStorage() {
		Objects.requireNonNull(storage);
		return storage;
	}

	public void setStorage(MerkleMap<ChunkPath, KeyedChunk<ChunkPath>> storage) {
